...
## 1) Scope
This Policy applies to Customers, Handymen, and Admin users. It covers personal data processed through the Platform, including identity data, wallet activity records, push notification tokens, and uploaded images (including ID images).

## 2) Data We Collect
### 2.1 Account and Profile Data
- Name (first/last name), username
- Email address
- Gender (if provided)
- Profile picture/avatar
- Role (customer/handyman/admin)

### 2.2 Location Data (User-Provided)
- Country (Nigeria)
- State, LGA, Local Council
- Street/address text entered by the user

### 2.3 Verification Data (Handyman)
- Address entered in handyman profile
- ID type and ID number
- ID image uploaded
- Verification status flags (verified, verifiedAt)

### 2.4 Orders and Messaging
- Order details (title, description, service category, schedule preferences)
- Order status timeline and activity events
- Chat messages exchanged between Order parties
...
- Handyman before/after photos
- Handyman work samples/portfolio images

## 3) How We Use Data
We process personal data to:
- Create and maintain user accounts
- Match and facilitate Orders between Customers and Handymen
- Display Order details, including location and photos, to the assigned parties
- Enforce the Order workflow (accepted/arrived/start/complete) and verification codes
- Run the wallet and escrow hold/release flow and generate transaction history
- Send push notifications and in-app communications about Order events and chat messages
